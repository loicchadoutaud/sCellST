...
This is a modification of the original implementation of HoVer-Net. 
The original implementation can be found [here](https://github.com/vqdang/hover_net).

The main modifications are:
- a different function to compute mask tissue from WSI.
- output formater to convert the output to a csv file.
- plot manager to plot the results of the model.

We used [pannuke weights](https://drive.google.com/file/d/1SbSArI3KOOWHxRlxnjchO7_MbWzB4lNR/view?usp=sharing) as the model weights which we put in a folder named _pretrained_.
